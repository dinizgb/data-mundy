...
export default function NewsCategoryHome() { //TODO: Transform the content of this page into a component
  return (
    <>
    <Head>
      <title>Data Mundy | News Category | Providing Data from and to an amazing World</title>
