...
export default function NewsHome() { //TODO: Transform the content of this page into a component
  return (
    <>
    <Head>
      <title>Data Mundy | News | Providing Data from and to an amazing World</title>
