...
export default function SpecialsHome() { //TODO: Transform the content of this page into a component
  return (
    <>
    <Head>
      <title>Data Mundy | Specials | Providing Data from and to an amazing World</title>
