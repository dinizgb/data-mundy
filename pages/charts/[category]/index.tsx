...
export default function ChartsCategoryHome() { //TODO: Transform the content of this page into a component
  return (
    <>
    <Head>
      <title>Data Mundy | Charts Category | Providing Data from and to an amazing World</title>
      ...
      <meta name="twitter:text:title" content="Charts Category Page" />
