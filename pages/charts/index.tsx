...
export default function ChartsHome() { //TODO: Transform the content of this page into a component
  return (
    <>
    <Head>
      <title>Data Mundy | Charts | Providing Data from and to an amazing World</title>
