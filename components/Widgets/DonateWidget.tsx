 ...
 */
export default function DonateWidget(props: DonateWidgetWrapperProps) {
  return (
    <DonateWidgetWrapper margin={props.margin}>
      ...
      >
        ...
        fringilla dignissim quam. Integer lobortis vel eros vel placerat. Sed
        erat nibh, iaculis id sapien id, lacinia condimentum neque.
      </H3>
      <PrimaryButton
        href="/donate"
        width={`150px`}
